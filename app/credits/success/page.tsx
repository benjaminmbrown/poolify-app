            ...
            <div style={{ marginTop: 24 }}>
              ...
              {roughGalleries && (
                <p style={valueHintStyle}>
                  ...
                  <span style={{ fontWeight: 600 }}>{roughGalleries}</span>{" "}
                  full sets of designs so you can confidently plan your
                  $80,000+ backyard project.
                </p>
              )}
            </div>
          )}
  ...
  const pieces = React.useMemo(
    () =>
      Array.from({ length: 80 }).map((_, i) => ({
        ...
        duration: 1.4 + Math.random() * 0.6, // seconds
...
/**
 * Next-steps checklist logic based on credit balance.
 */
...
/**
 * Format ISO to a short human-readable string.
 */
